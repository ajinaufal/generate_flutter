...
class _$_ExampleModel implements _ExampleModel {
  const _$_ExampleModel(
      {this.count, this.next, this.previous, final List<ResultModel>? results})
      : _results = results;
  ...
  @override
  String toString() {
    return 'ExampleModel(count: $count, next: $next, previous: $previous, results: $results)';
  }
...
abstract class _ExampleModel implements ExampleModel {
  const factory _ExampleModel(
      ...
      final String? next,
      final dynamic? previous,
      final List<ResultModel>? results}) = _$_ExampleModel;
...
class _$_ResultModel implements _ResultModel {
  const _$_ResultModel({this.name, this.url});
...
abstract class _ResultModel implements ResultModel {
  const factory _ResultModel({final String? name, final String? url}) =
      _$_ResultModel;
